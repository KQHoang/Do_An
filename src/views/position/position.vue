<template>
    ...
    <position-add-edit v-if="showAddAndEdit"
    ...
    <div class="manage-profile">
        <div class="title">Quản lý chức vụ</div>
        <div class="main-manage-profile m-t-12 p-b-12">
            ...
            <table-vue
                ...
                :headers="HEADERR_TABLE.POSITION" 
                :showPaging="true"
                :showSelect="false"
                :deleteRow="false"
                :showBorder="false"
...
import PositionAddAndEdit from '@/views/position/addAndEdit.vue';
export default{
    name: "ManagePosition",
    components:{
        VueInput: input,
        ...
        'position-add-edit': PositionAddAndEdit
    }, 
    data(){
        return {
            showLoading: false,
    ...
    methods:{
        ...
        async getDataPaging(){
            ...
            var res = await PositionAPI.getPagingPosition(this.pagingControl);
