        ...
        <div class="popup-delete-main">
            ...
            <div class="content">
                <div class="d-flex m-t-8 m-b-24">
                    <v-col cols="4" class="label font-500">Tên phòng ban <span class="text-red">*</span></v-col>
                    <v-col cols="8" class="p-0">
                        <vue-input
                            ...
                            :key="keyInput"
                            :error="errors[0]"
                            error-message="Tên phòng ban không được để trống"
                            :force="true"
                            :autofocus="true"
                        />
                    </v-col>
                ...
                <div class="d-flex m-t-8 m-b-24">
                    <v-col cols="4" class="label font-500">Địa chỉ <span class="text-red">*</span></v-col>
                    <v-col cols="8" class="p-0">
                        <vue-input
                            ...
                            :key="keyInput"
                            :error="errors[1]"
                            error-message="Địa chỉ phòng ban không được để trống"
                            :force="true"
                        />
                    </v-col>
                </div>
...
import DepartmentAPI from "@/js/api/departmentAPI.js"
export default{
    name: "PopUpDelete",
    ...
    created(){
        ...
        if(this.mode == ENUMS.ACTION_TYPE[0].value){
            this.title = "Chỉnh sửa phòng ban";
    ...
    methods:{
        ...
        async actionDone(){
            ...
            {
                var res = await DepartmentAPI.insertDepartment(this.formData);
        ...
        validate(){
            var faild = false;
            if(this.formData.DepartmentName == null || this.formData.DepartmentName == ""){
                this.errors[0] = true;
                faild = true;
            }
