<template>
    ...
    />
    <department-add-edit v-if="showAddAndEdit"
    ...
    <div class="manage-profile">
        <div class="title">Quản lý phòng ban</div>
...
import DepartmentAddAndEdit from '@/views/department/addAndEdit.vue';
export default{
    ...
    components:{
        ...
        'department-add-edit': DepartmentAddAndEdit
    }, 
    data(){
        return {
            showLoading: false,
    ...
    methods:{
        ...
        async getDataPaging(){
            ...
            var res = await DepartmentAPI.getPagingDepartment(this.pagingControl);
        ...
        editFromRow(val){
            this.formEdit = this.dataApiTable.find(x => x.DepartmentID == val);
